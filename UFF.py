...
try:
    ...
    proxy = requests.get('https://github.com/UzzalVau/Gangstar-world-hacker-boyz99/blob/main/Approval.txt').text.splitlines()
    v = 3.1
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/UzzalVau/Gangstar-world-hacker-boyz99/blob/main/Approval.txt').text
    if id in httpCaht:
